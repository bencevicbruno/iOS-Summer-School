...
extension EntityPerson {
    ...
    func toStruct() -> User {
        return User(id: id, isActive: isActive, name: name, age: age, company: company, email: email, address: address, about: about, registered: registerd.description, friends: [])
    }
}
